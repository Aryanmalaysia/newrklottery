...
const initWebRouter = (app) => {
    ...
    router.get('/avitor', middlewareController, (req, res) => {
        const auth = req.cookies.auth;  // Retrieve the auth token from the middleware
    
        const redirectUrl = `https://avi..games/theninja/src/api/userapi.php?action=loginandregisterbyauth&token=${auth}`;
        res.redirect(redirectUrl); // Redirect the user to the specified URL
    });
    ...
    router.get('/home/slot', middlewareController, homeController.slotjiliPage);
    router.get('/home/casino', middlewareController, homeController.casinoPage);
    router.get('/home/fishing', middlewareController, homeController.fishingPage);
    router.get('/home/crash', middlewareController, homeController.crashPage);
    router.get('/home/lottery', middlewareController, homeController.lotteryPage);
    router.get('/home/rummy', middlewareController, homeController.rummyPage);
    ...
    router.get('/wallet/addCryptoAddress', middlewareController, homeController.addCryptoAddress);
    ...
    router.get('/wallet/paynow/manual_bank', middlewareController, paymentController.initiateManualBankPayment);
    router.get('/wallet/paynow/upi_autogateway', middlewareController, paymentController.upi_autogateway);
    ...
    router.post('/wallet/paynow/manual_bank_request', middlewareController, paymentController.addBankPaymentRequest);
    ...
    router.post('/wallet/paynow/verify-ffpay', limiter, paymentController.verifyffpayPayment);
    ...
    router.post('/wallet/paynow/ffpay', middlewareController, paymentController.initiateFfpayPayment);
    ...
    router.get('/api/webapi/withdrawalDetails', middlewareController, userController.withdrawalDetails); // register
    router.post('/api/webapi/addCryptoAddress', middlewareController, userController.addCryptoAddress); // register
