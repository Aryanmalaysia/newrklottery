function showListOrder3(list_orders, x) {
  ...
  let chart = list_orders.map((list_orders) => {
    return (htmlchart += `
               ...
               <li>
                   <div class="first">${list_orders.period}</div>
                   <div class="sec">
                      <span class="${
                        list_orders.amount == 0 ? `active zero ` : ""
                      }">0</span>
                       <span class="${
                         list_orders.amount == 1 ? `active one` : ""
                       }">1</span>
                       <span class="${
                         list_orders.amount == 2
                           ? `active ${list_orders.amount}`
                           : ""
                       }">2</span>
                       <span class="${
                         list_orders.amount == 3
                           ? `active ${list_orders.amount}`
                           : ""
                       }">3</span>
                       <span class="${
                         list_orders.amount == 4
                           ? `active ${list_orders.amount}`
                           : ""
                       }">4</span>
                       <span class="${
                       ...
                       <span class="${
                         list_orders.amount == 6
                           ? `active ${list_orders.amount}`
                           : ""
                       }">6</span>
                       <span class="${
                         list_orders.amount == 7
                           ? `active ${list_orders.amount}`
                           : ""
                       }">7</span>
                       <span class="${
                         list_orders.amount == 8
                           ? `active ${list_orders.amount}`
                           : ""
                       }">8</span>
                       <span class="${
                         list_orders.amount == 9
                           ? `active ${list_orders.amount}`
                           : ""
                       }">9</span>
                   </div>
    ...
    return (htmlchart += `
                ...
                <li>
                    ...
                    <div class="sec">
                        ...
                        <span class="${
                          list_orders.amount == 2 ? `active two` : ""
                        }">2</span>
                        <span class="${
                          list_orders.amount == 3 ? `active three` : ""
                        }">3</span>
                        <span class="${
                          list_orders.amount == 4 ? `active four` : ""
                        }">4</span>
                        <span class="${
                          list_orders.amount == 5 ? `active five` : ""
                        }">5</span>
                        <span class="${
                          list_orders.amount == 6 ? `active six` : ""
                        }">6</span>
                        <span class="${
                          list_orders.amount == 7 ? `active seven` : ""
                        }">7</span>
                        <span class="${
                          list_orders.amount == 8 ? `active eight` : ""
                        }">8</span>
                        <span class="${
                          list_orders.amount == 9 ? `active nine` : ""
                        }">9</span>
                    </div>
                    <div class="third ${
                      list_orders.amount < 5 ? "color-blue" : "color-yellow"
                    }" >${list_orders.amount < 5 ? "S" : "B"}</div>
                </li>
...
$(`.game-betting .box .item .img .van-image img`).attr(
  "src",
  "/images/icon_clock-gerrn.svg"
);
$(
  `.game-betting .box .item:eq(${selectPageTime - 1}) .img .van-image img`
).attr("src", "/images/icon_clock-red.svg");
